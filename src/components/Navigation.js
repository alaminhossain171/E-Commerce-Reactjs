...
function handleMenuClick(){
  setClick(!click)
    ...
    return (<>
        ...
        <Container>
       <Navbar.Brand > <Link to='/' className='Link'>Online-Shop!</Link>  </Navbar.Brand> 
          <Navbar.Toggle className='Toggle-class' aria-controls="basic-navbar-nav"
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link><Link to='/' className='Link' onClick={handleShow}>ACCOUNT</Link>  </Nav.Link>
              <Nav.Link>
             <Link to='/Cart'>
 ...
 <Button variant="primary" type="submit" className='mx-3 order' onClick={(e)=>e.preventDefault()}>
  LOGIN
  </Button>

 </div>
 <p className='text-center text-muted mt-3'>Do't have an account yet! click on Register</p>
</Form>
        </Modal.Body>
