      ...
      <div className="container mb-5 mt-5">
        ...
        <div className="my-2 text-center">
          <ButtonGroup aria-label="Basic example">
            <Button onClick={() => setItem(data)} variant="outline-warning">
              <b>All</b>
            </Button>
            <Button
              onClick={() => filterMenu("men's clothing")}
              variant="outline-warning"
            >
              <b>Men's Clothing</b>
            </Button>
            <Button
              onClick={() => filterMenu("jewelery")}
              variant="outline-warning"
            >
              <b>Jwelery</b>
            </Button>
            <Button
              onClick={() => filterMenu("electronics")}
              variant="outline-warning"
            >
              <b>Electronics</b>
            </Button>
            <Button
              onClick={() => filterMenu("women's clothing")}
              variant="outline-warning"
            >
